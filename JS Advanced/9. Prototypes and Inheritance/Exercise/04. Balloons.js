...
let balloonClasses = getBalloonsClasses();

let testBalloon = new balloonClasses.Balloon("yellow", 20.5);

let testPartyBalloon = new balloonClasses.PartyBalloon("yellow", 20.5, "red", 10.25);
